    ...
    <div class="main-content">
        @foreach($areas as $area)
            <div class="card area-card" style="width: 18rem;">
                <img src="{{ $area->image ?? "https://w7.pngwing.com/pngs/424/251/png-transparent-color-wheel-habersetzer-und-kollegen-gmbh-color-theory-color-scheme-location-logo-television-logo-color.png" }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <a href="/area/{{ $area->id }}">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownCardMenu{{ $area->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                            Управление
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownCardMenu{{ $area->id }}">
                            <li><a class="dropdown-item" href="/area/{{ $area->id }}/edit">Изменить</a></li>
